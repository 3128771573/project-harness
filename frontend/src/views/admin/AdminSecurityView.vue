<template>
  <div>
    ...
    <div class="table-wrap">
      <table class="table">
        <thead>
          <tr><th>时间</th><th>用户</th><th>IP</th><th>设备</th><th>结果</th><th>原因</th></tr>
        </thead>
        <tbody>
          ...
          <tr v-if="items.length === 0"><td colspan="6" style="text-align:center;padding:36px 0" class="muted">暂无登录记录</td></tr>
        </tbody>
      </table>
